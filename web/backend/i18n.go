...
var translations = map[Language]map[TranslationKey]string{
	LanguageEnglish: {
		...
		MenuQuit:           "Quit",
		MenuQuitTooltip:    "Exit TsingPaw",
		Exiting:            "Exiting TsingPaw...",
		DocUrl:             "https://docs.tsingpaw.io/docs/",
	},
	LanguageChinese: {
		AppTooltip:         "%s - Web Console",
		MenuOpen:           "打开控制台",
		MenuOpenTooltip:    "在浏览器中打开 TsingPaw 控制台",
		MenuCopyToken:      "复制控制台口令",
		MenuCopyTokenHint:  "将当前 Web 控制台访问口令复制到剪贴板",
		MenuAbout:          "关于",
		MenuAboutTooltip:   "关于 TsingPaw",
		MenuVersion:        "版本: %s",
		...
		MenuQuit:           "退出",
		MenuQuitTooltip:    "退出 TsingPaw",
		Exiting:            "正在退出 TsingPaw...",
		DocUrl:             "https://docs.tsingpaw.io/zh-Hans/docs/",
	},
}
